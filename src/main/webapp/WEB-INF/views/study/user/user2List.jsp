...
<head>
	...
	<script>
		...
		function fNewForm() {
			...
			str += '<tr>';
			str += '<th>나이</th>';
			str += '<td><input type="number" name="age" value="20" class="form-control" required /></td>';
			str += '</tr>';
			str += '<tr>';
			str += '<th>주소</th>';
			str += '<td><input type="text" name="address" class="form-control" required /></td>';
			str += '</tr>';
			str += '<tr>';
			str += '<th colspan="2" class="text-center"><input type="submit" value="회원가입" class="btn btn-info"/></th>';
			str += '</tr>';
			str += '</table>';
			str += '</form>';
...
<div class="container">
	...
	<div class="row">
		<div class="col">
			<input type="button" value="회원가입폼" onclick="fNewForm()" class="btn btn-primary btn-sm mb-2"/>
		</div>
