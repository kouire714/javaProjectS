...
<div class="container">
	<h2>SHA-256</h2>
	<div>
		SHA256 암호화 방식은 SHA(Secure Hash Algorithm) 알고리즘의 한 종류로, 256비트로 구성되며 64자리 문자열로 구성된다.<br/>
		SHA256은 단방향 암호화 방식으로 복호화가 불가능하고, 속도가 빠르다는 장점이 있다.
	</div>
	<br/>
	<div>
		<input type="text" name="pwd" id="pwd" autofocus />
		<input type="button" value="sha256암호화" onclick="shr256check()" class="btn btn-success"/>
